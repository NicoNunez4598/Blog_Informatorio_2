"""
Django settings for Blog_Online project.
...
WSGI_APPLICATION = 'Blog_Online.wsgi.application'
...
AUTH_USER_MODEL ='GestionDeBlog.Usuario'
...
# Variables de Entorno LOGIN Y LOGOUT
